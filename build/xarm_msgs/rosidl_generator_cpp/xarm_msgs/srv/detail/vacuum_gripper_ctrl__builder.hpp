...
class Init_VacuumGripperCtrl_Request_hardware_version
{
public:
  explicit Init_VacuumGripperCtrl_Request_hardware_version(::xarm_msgs::srv::VacuumGripperCtrl_Request & msg)
  : msg_(msg)
  {}
  ::xarm_msgs::srv::VacuumGripperCtrl_Request hardware_version(::xarm_msgs::srv::VacuumGripperCtrl_Request::_hardware_version_type arg)
  {
...
class Init_VacuumGripperCtrl_Request_sync
{
public:
  explicit Init_VacuumGripperCtrl_Request_sync(::xarm_msgs::srv::VacuumGripperCtrl_Request & msg)
  : msg_(msg)
  {}
  Init_VacuumGripperCtrl_Request_hardware_version sync(::xarm_msgs::srv::VacuumGripperCtrl_Request::_sync_type arg)
  {
    msg_.sync = std::move(arg);
    return Init_VacuumGripperCtrl_Request_hardware_version(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_VacuumGripperCtrl_Request_sync delay_sec(::xarm_msgs::srv::VacuumGripperCtrl_Request::_delay_sec_type arg)
  {
    msg_.delay_sec = std::move(arg);
    return Init_VacuumGripperCtrl_Request_sync(msg_);
  }
