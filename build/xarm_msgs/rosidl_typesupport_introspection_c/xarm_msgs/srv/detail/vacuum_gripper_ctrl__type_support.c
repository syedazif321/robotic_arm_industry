...
static rosidl_typesupport_introspection_c__MessageMember xarm_msgs__srv__VacuumGripperCtrl_Request__rosidl_typesupport_introspection_c__VacuumGripperCtrl_Request_message_member_array[6] = {
  {
    "on",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xarm_msgs__srv__VacuumGripperCtrl_Request, sync),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xarm_msgs__srv__VacuumGripperCtrl_Request, hardware_version),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
