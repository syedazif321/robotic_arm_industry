...
static const _PlanExec_Request_type_support_symbol_names_t _PlanExec_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, PlanExec_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, PlanExec_Request)),
  }
};
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_cpp::PlanExec_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xarm_msgs, srv, PlanExec_Request)() {
  return get_message_type_support_handle<xarm_msgs::srv::PlanExec_Request>();
}
...
static const _PlanExec_Response_type_support_symbol_names_t _PlanExec_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, PlanExec_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, PlanExec_Response)),
  }
};
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_cpp::PlanExec_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xarm_msgs, srv, PlanExec_Response)() {
  return get_message_type_support_handle<xarm_msgs::srv::PlanExec_Response>();
}
...
static const _PlanExec_type_support_symbol_names_t _PlanExec_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, PlanExec)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, PlanExec)),
  }
};
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_cpp::PlanExec_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, xarm_msgs, srv, PlanExec)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<xarm_msgs::srv::PlanExec>();
}
