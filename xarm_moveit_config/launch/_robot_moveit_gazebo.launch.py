...
def launch_setup(context, *args, **kwargs):
    ...
    geometry_mesh_filename = LaunchConfiguration('geometry_mesh_filename', default='object.stl')
    geometry_mesh_origin_xyz = LaunchConfiguration('geometry_mesh_origin_xyz', default='"0 0 0.11"')
    geometry_mesh_origin_rpy = LaunchConfiguration('geometry_mesh_origin_rpy', default='"0 3.14 0"')
    geometry_mesh_tcp_xyz = LaunchConfiguration('geometry_mesh_tcp_xyz', default='"0 0 0.11"')
